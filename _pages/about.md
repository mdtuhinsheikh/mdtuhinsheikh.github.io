...
* Recieved the prestigious "[IBM Student Research Award](https://nestat.org/ibmawards/ibm2021/){:target="_blank"}" at the New England Statistics Symposium, Sep 28 - Oct 2, 2021.
...
* Worked on the "EnergyStats" project, where we developed an [RShiny dashboard](http://energystats.fo.uconn.edu:9999/){:target="_blank"} with the real-time energy and utility data at UConn. [Note: the link works under the UConn VPN at this moment.]
